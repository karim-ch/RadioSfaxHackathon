package com.RadioSfax.acer.radiosfax.player;
...
public class RadioService extends Service implements Player.EventListener, AudioManager.OnAudioFocusChangeListener {
    ...
    public static final String ACTION_PLAY = "com.example.acer.radiosfax.player.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.example.acer.radiosfax.player.ACTION_PAUSE";
    public static final String ACTION_STOP = "com.example.acer.radiosfax.player.ACTION_STOP";
