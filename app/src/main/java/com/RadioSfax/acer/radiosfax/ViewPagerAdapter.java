...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    private Integer [] images = {R.drawable.dimanche,R.drawable.lundi,R.drawable.mardi,
            R.drawable.mercredi,R.drawable.jeudi,R.drawable.vendredi,R.drawable.samedi};
